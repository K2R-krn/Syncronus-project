// export const HOST = import.meta.env.VITE_SERVER_URL; // vite url as using vite..
// export const BASE_URL= import.meta.env.VITE_SERVER_URL;

export const HOST = `https://syncronus-be-production.up.railway.app`;

export const AUTH_ROUTES = `${HOST}api/auth`;
export const SIGNUP_ROUTE = `${AUTH_ROUTES}/signup`;
export const LOGIN_ROUTE = `${AUTH_ROUTES}/login`;
export const GET_UESR_INFO = `${AUTH_ROUTES}/user-info`;
